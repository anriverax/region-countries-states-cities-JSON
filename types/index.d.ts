...
export declare function getAllCountries(fields?: string[]): Partial<Country>[];
...
export declare function getCountriesByTranslation(translation: string): Country[];
export declare function getCountriesByRegion(region: string): Country[];
export declare function getCountriesByCodes(codes: string[]): Country[];
export declare function getCountryByFullName(name: string): Country | null;
export declare function getCountriesByName(name: string): Country[];
